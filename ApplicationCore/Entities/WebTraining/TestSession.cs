...
{ 
  public class TestSession : CatalogEntityModel
  {
    ...
    public int ObjectId { get { return Id; } set { Id = value; } }
    ...
    {
      get => _testers ?? (_testers = TesterData == null ? new TesterList() : TesterList.Deserialize(TesterData));
      set
      {
        _testers = value;
    ...
    [NotMapped]
    public DateTime LastUpdatedLocal { get => LastUpdated.ToLocalTime();
      set => LastUpdated = value.ToUniversalTime();
    }
